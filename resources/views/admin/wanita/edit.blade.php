...
@section('main-content')
    <!-- Page Heading -->
    <div class="mb-6">
        <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Edit Biodata Wanita</h1>
        <p class="text-sm text-slate-500 mt-1">Perbarui informasi biodata pengantin wanita</p>
    </div>
    ...
    <div class="max-w-3xl bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            <form action="{{ route('biodataWanita.update', $biodataWanita->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
