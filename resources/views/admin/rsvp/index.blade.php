                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('rsvp.edit', $rsvp->id) }}" 
                                        ...
                                        <form action="{{ route('rsvp.destroy', $rsvp->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data RSVP ini?');" class="inline-block">
                                            @csrf
                                            @method('DELETE')
