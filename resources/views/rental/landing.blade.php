...
<head>
    ...
    <title>Sewa Web Undangan Pernikahan – Luiz-Wedding</title>
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    fontFamily: { sans: ['"Plus Jakarta Sans"', 'sans-serif'], script: ['Sacramento', 'cursive'] }
                }
            }
        }
    </script>
    <style>
        ...
        .card-glow:hover { box-shadow: 0 0 40px rgba(139,92,246,0.25); }
        .badge-populer { animation: pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite; }
    </style>
</head>
<body class="font-sans antialiased bg-slate-50">
    ...
    <section class="gradient-hero text-white py-20 px-4 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto text-center relative z-10">
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur rounded-full text-sm font-medium mb-6 border border-white/20">
                ...
                Luiz-Wedding Digital Invitation
            </div>
    ...
    <footer class="bg-slate-900 text-slate-400 py-6 text-center text-sm">
        © {{ date('Y') }} Luiz-Wedding. All rights reserved.
    </footer>
</body>
</html>
